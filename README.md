...
GCE module and passes them to the Android Library for display. The Joke serving code runs
similarly to my colider web app for my CS50 final project.  

## Below is a detailed description of what I had to write at each step of the assignment.
